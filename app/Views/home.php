    ...
    <div class="container" data-aos="fade-up">
      <div class="row">
        ...
        <div class="col-xl-5 col-lg-5 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="150">
          <div class="home-hero">
            <img src="<?=base_url()?>/img/home.webp" class="img-fluid" alt="home">
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="row d-flex align-items-center">
            <div class="col-lg-1">&nbsp;</div>
              <div class="col-lg-6" data-aos="fade-right" data-aos-delay="150">
                  <img src="<?=base_url()?>/img/coder.png" class="img-fluid" alt="coder">
              </div>
                ...
                <li class="main-li">
                  ...
                  <div class="descr">
                    ...
                    <ul class="level-icons">
                      ...
                      <li><img src="<?=base_url()?>/img/icons/sql-server.png" alt="sql-server" title="sql-server"></li>
                    </ul>
                  </div>
                </li>
                <li class="main-li">
                  ...
                  <div class="descr">
                    ...
                    <div><i class="bi-dot"></i> Meet industry experts</div>
                    <ul class="level-icons">
                      <li><img src="<?=base_url()?>/img/icons/react-native.png" alt="react-native" title="react-native"></li>
                    </ul>
                  </div>
                </li>
                <li class="main-li">
                  ...
                  <div class="descr">
                    ...
                    <ul class="level-icons">
                      <li><img src="<?=base_url()?>/img/icons/github.png" alt="github" title="github"></li>
                      <li><img src="<?=base_url()?>/img/icons/bitbucket.png" alt="bitbucket" title="bitbucket"></li>
    ...
    <section id="Certification" class="unique section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="certificate-bg">
          <img src="<?=base_url()?>/img/certificate-2.jpg" alt="certificate" class="img-fluid">
        </div>
      </div>
    </section>
